...
Detailed logic for V/E Ratio calculation, 2×2 matrix visualization, classifications, and portfolio balance.

## V/E Ratio (Value/Effort Ratio)

The V/E Ratio provides a single metric for comparing opportunities across different scales.
...
3. "Meeting Follow-up Bot" (40% similar)
   - Same trigger: Post-meeting action
   - Similar: Summarization component
   - Different: Different output format
   - Benchmark: 5-8 hours
